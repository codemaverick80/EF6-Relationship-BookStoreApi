INSERT INTO languages (language_code, id, language_name) VALUES
('eng', 1, 'English'),
...
INSERT INTO shipping_method (id, method_name, cost) VALUES
(1, 'Standard', 5.9),
(2, 'Priority', 8.9),
(3, 'Express', 11.9),
...
INSERT INTO address_status (id, status) VALUES
(1, 'Active'),
(2, 'Inactive');
